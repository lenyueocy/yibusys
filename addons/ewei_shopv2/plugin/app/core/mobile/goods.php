...
class Goods_EweiShopV2Page extends AppMobilePage
{
    ...
    public function get_list()
    {
        ...
        if (!empty($couponid)) {
            ...
            $args = array(
                ...
                "minprice" => floatval($_GPC["minprice"]),
                "maxprice" => floatval($_GPC["maxprice"]),
            ...
            //if(!empty($_GPC['cate'])) $args['keywords'] = '';
    ...
    public function get_detail()
    {
        ...
        if($goods['province']=='请选择省份') unset($goods['province']);
        if($goods['city']=='请选择城市') unset($goods['city']);
