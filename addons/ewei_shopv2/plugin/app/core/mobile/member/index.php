...
class Index_EweiShopV2Page extends AppMobilePage
{
	public function main()
	{
		...
		$result['address'] = pdo_count('ewei_shop_member_address',['openid'=>$_W['openid'],'uniacid'=>$_W['uniacid']]);


		//$goods_list = m('goods')->getList(['page'=>!empty($_GPC['page'])?$_GPC['page']:1,'pagesize'=>10,'random'=>true]);
		//$result['recommand'] = $goods_list;
