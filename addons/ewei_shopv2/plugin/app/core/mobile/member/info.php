...
class Info_EweiShopV2Page extends AppMobilePage
{
    ...
    public function main()
    {
        ...
        $result = array(
            ...
            'is_certification' => $member['is_certification'],
    ...
    public function setClientId(){
        global $_W,$_GPC;
        if(empty($_GPC['clientid'])) return app_json(1);
        pdo_update('ewei_shop_member',['clientid'=>$_GPC['clientid']],['openid'=>$_W['openid'],'uniacid'=>$_W['uniacid']]);
        return app_json(1);
    }
}
