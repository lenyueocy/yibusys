...
define("APPKEY","lqx7YY4qqP61SUjFWJuz11");
define("APPID","yPG81qIyo68kFnRXWL5wJ8");
define("MS","esee93tl4r6XOQOWaHrlV3");
...
function pushAll($api){
    $push = new GTPushRequest();
    $push->setRequestId(time());
    $push->setGroupName('测试');

    $message = new GTPushMessage();

    $notify = new GTNotification();
    $notify->setTitle("测试通知");
    $notify->setBody("测试内容");
