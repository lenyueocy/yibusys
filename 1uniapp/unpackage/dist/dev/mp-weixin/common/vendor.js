...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"奋钧智慧照明商城","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var utils = {
  ...
  modal: {
    alert: function alert(content, title) {
      ...
      _index3.default.state.modalAction.title = title || '提示';
      _index3.default.state.modalAction.content = content || '提示';
    ...
    confirm: function confirm(content, confirmText, cancelText, title) {
      return new Promise(function (resolve, reject) {
        ...
        _index3.default.state.modalAction.confirmText = confirmText || '确定';
        _index3.default.state.modalAction.cancelText = cancelText || '取消';
        _index3.default.state.modalAction.content = content || '确认此操作？';
