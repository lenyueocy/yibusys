			...
			<radio-group>
				<tui-list-cell unlined :hover="false">
					<label class="tui-pay-item">
						<image src="/static/icon/pay/icon_pay_balance.png" class="tui-pay-logo"></image>
				...
				<tui-list-cell unlined>
					<label class="tui-pay-item">
						<image src="/static/icon/pay/icon_pay_weixin.png" class="tui-pay-logo"></image>
						<text>微信支付</text>
				...
				<tui-list-cell unlined>
					<label class="tui-pay-item">
						<image src="/static/icon/pay/icon_pay_zhifubao.png" class="tui-pay-logo"></image>
						<text>支付宝支付</text>
						<view class="tui-radio">
							<radio color="#EB0909" name="pay"></radio>
						</view>
