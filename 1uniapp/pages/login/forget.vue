			...
			<view class="tui-view-input">
				...
				<tui-list-cell :hover="false" :lineLeft="false" backgroundColor="transparent">
					<view class="tui-cell-input">
						...
						<input :value="pwd" placeholder="请输入新密码" :password="true" placeholder-class="tui-phcolor" type="text" maxlength="40" @input="inputPwd" />
                ...
                <tui-list-cell :hover="false" :lineLeft="false" backgroundColor="transparent">
                    <view class="tui-cell-input">
                        <tui-icon name="pwd" color="#6d7a87" :size="20"></tui-icon>
                        <input :value="checkpwd" placeholder="请再次确认您的新密码" :password="true" placeholder-class="tui-phcolor" type="text" maxlength="40" @input="inputCheckPwd" />
...
export default {
	...
	methods: {
        send(e){
            ...
            this.$http.get('sms.forget',{mobile:this.mobile}).then((res)=>{
        ...
        submit(){
            ...
            this.$http.get('account.changepwd',{mobile:this.mobile,pwd:this.pwd,verifycode:this.verifycode}).then((res)=>{
