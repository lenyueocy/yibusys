			...
			<view v-if="listData.length>0">
				<tui-list-cell :hover="false" :lineLeft="false"  v-for="(item,index) in listData">
					<view class="flex align-center justify-between" >
						<view ><image :src="'http://appstore.bai918.com/static/app/images/index_fudai.png'" class="" style="width: 80rpx;height: 80rpx;"></image></view>
...
<script>
    ...
    export default{
        ...
        methods:{
            getList:function () {
                let params = {page:this.mescroll.num,pagesize:this.mescroll.size,type:'credit1'}
