<template>
    <view >
            ...
            <tui-list-cell padding="30rpx 30rpx 50rpx 30rpx" :lineLeft="false" :hover="false" @click="detail" >
                <view class="tui-item-box">
                    <view class="tui-msg-box">
                        <image :src="departmentData.logo" class="tui-msg-pic" mode="widthFix"></image>
                        <view class="tui-msg-name">{{departmentData.name}}</view>
                    </view>
                </view>
            </tui-list-cell>
        </view>
        ...
        <tui-list-view title="预约医生" style="background-color: #F2F2F2;" v-if="doctorList">
            <tui-list-cell :lineLeft="false" v-for="(item,index) in doctorList" @click="$Router.push({name:'appoint_submit',params:{doctorid:item.id}})">
                <view class="tui-item-box">
                    <view class="tui-msg-box">
                    ...
                    <view class="tui-msg-right">
                        <button class="cu-btn tui-btn-danger sm margin-top-xs" style="white-space: nowrap;">立即预约</button>
                    </view>
                </view>
            </tui-list-cell>
        </tui-list-view>

        <tui-list-view unlined="all" title="预约医生" style="background-color: #F2F2F2;" v-else>
            <tui-no-data class="padding-top-xl bg-white" :fixed="false" imgUrl="/static/images/toast/img_nodata.png"  @click="getList">
    ...
    export default {
        ...
        methods: {
            getList: function () {
                ...
                this.$http.get('department.get_detail',{id:this.$Route.query.id}).then((res) => {
