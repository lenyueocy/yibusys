				...
				<block v-for="(row,index) in keywordList" :key="index">
					<view class="keyword-entry" hover-class="keyword-entry-tap" >
						...
						<view class="keyword-img" @tap.stop="setKeyword(keywordList[index].keyword)">
							<image src="http://appstore.bai918.com/static/app/HM-search/back.png"></image>
						</view>
					</view>
				</block>
			...
			<scroll-view class="keyword-box" v-show="!isShowKeywordList" scroll-y>
				<view class="keyword-block" v-if="oldKeywordList.length>0">
					<view class="keyword-list-header">
						<view>历史搜索</view>
						<view>
							<image @tap="oldDelete" src="http://appstore.bai918.com/static/app/HM-search/delete.png"></image>
						</view>
					</view>
					<view class="keyword">
				...
				<view class="keyword-block">
					<view class="keyword-list-header">
						<view>热门搜索</view>
						<view>
							<image @tap="hotToggle" :src="'http://appstore.bai918.com/static/app/HM-search/attention'+forbid+'.png'"></image>
						</view>
					</view>
