        ...
        <scroll-view scroll-with-animation scroll-y="true" @touchmove="hideKey"
            ...
            <view id="okk" scroll-with-animation>
                ...
                <view class="flex-column-start" v-for="(x,i) in msgList" :key="i">
                    ...
                    <!-- 用户消息 头像可选加入-->
                    <view v-if="x.my" class="flex justify-end one-show  align-start  padding-top">
                        <view class="flex justify-end" style="width: 85%;">
                            <view class="padding-chat bg-cyan flex align-center" style="border-radius: 35rpx;">
                                <text style="word-break: break-all;">{{x.msg}}</text>
                            </view>
                            <view class="flex-row-center padding-lr-xs">
                                <image style="height: 90rpx;width:90rpx;" src="../../static/missing-face.png" mode="aspectFit"></image>
                            </view>
                        </view>
                    </view>
                    <!-- 机器人消息 -->
                    <view v-if="!x.my" class="flex-row-start margin-top one-show">
                        <view class="chat-img flex-row-center margin-lr-xs">
                            <image style="height: 75rpx;width: 75rpx;" src="../../static/robt.png" mode="aspectFit"></image>
                        </view>
                        <view class="flex" style="width: 500rpx;">
                            <view class="padding-chat flex-column-start" style="border-radius: 35rpx;background-color: #f9f9f9;">
                                <text style="word-break: break-all;">{{x.msg}}</text>
                                <!-- 消息模板 =>初次问候 -->
                                <view class="flex-column-start" v-if="x.type==1" style="color: #2fa39b;">
                                    ...
                                    <text @click="answer(index)" style="margin-top: 30rpx;" v-for="(item,index) in x.questionList" :key="index">{{item}}
                                    </text>
                                ...
                                <view class="flex-column-start" v-if="x.type==0">
                                    ...
                                    <text @click="answer(index)" style="margin-top: 30rpx;color: #2fa39b;" v-for="(item,index) in x.questionList" :key="index">{{item}}
                                    </text>
                                    <view class="flex-row-start  padding-top-sm">
                                        <text class="my-neirong-sm">没有你要的答案?</text>
    ...
    export default {
        ...
        data() {
            return {
                ...
                msgList: [{
                    my: false, msg: "你好我是客服机器人娜娜,请问有什么问题可以帮助您?(问候模板)",
...
<style lang="scss">
    @import "/static/css/kefu-index.css";
    .bottom-dh-char {
